...
VERSIONS = [
    ...
    # v3 attempts: 20k -> 60k -> 200k -> 500k samples (patience=80 throughout,
    # never the bottleneck), each preserved under its own name to show the
    # delta. v3 itself always points at the latest attempt. Older attempts
    # (20k, 60k) dropped from this list once clearly superseded -- see
    # compare_pff_v1_v2_v3.log history for their numbers if needed.
    ("v3_a4_500k", "model_pff_v3_attempt4_500k.keras", "pff_training_results_v3_attempt4_500k.json", True),
    ("v3_a5_1M", "model_pff_v3_attempt5_1M.keras", "pff_training_results_v3_attempt5_1M.json", True),
