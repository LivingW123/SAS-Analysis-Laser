...
Usage
-----
  python -m src.training.pff.train_pff_bumpcenter_prior

Outputs
-------
  out/training/pff/model_pff_bumpcenter_proto.keras
  out/training/pff/pff_training_results_bumpcenter_proto.json
  out/training/pff/pff_bumpcenter_proto_real_shots.csv
...
MODEL_PATH      = os.path.join(OUT_DIR, "model_pff_bumpcenter_proto.keras")
RESULTS_JSON    = os.path.join(OUT_DIR, "pff_training_results_bumpcenter_proto.json")
REAL_SHOTS_CSV  = os.path.join(OUT_DIR, "pff_bumpcenter_proto_real_shots.csv")
